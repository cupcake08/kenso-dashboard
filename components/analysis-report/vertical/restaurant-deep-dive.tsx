import type { RestaurantMetrics } from "@/types/analysis";
import { QuoteCard } from "../quote-card";

export function RestaurantDeepDive({ metrics }: { metrics: RestaurantMetrics }) {
  ...
  if (!hasUpsells && !hasComplaints && paymentEntries.length === 0) return null;

  return (
    <section className="my-10">
      <h3 className="font-display text-xs uppercase tracking-widest text-muted-foreground mb-4">Restaurant deep dive</h3>
